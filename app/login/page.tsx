...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-200 flex items-center justify-center p-6 font-sans selection:bg-gray-900 selection:text-white relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[15rem] font-black text-gray-300/30 whitespace-nowrap pointer-events-none tracking-tighter -rotate-6">
        LOG IN
      </div>

      {/* Main Login Card - Brutalist Style */}
      <div className="relative z-10 w-full max-w-md bg-white border-4 border-gray-900 shadow-[12px_12px_0px_0px_rgba(17,24,39,1)] transition-all duration-300">
        ...
        <div className="bg-gray-900 px-8 py-10 text-left relative overflow-hidden group">
          ...
          <p className="text-gray-400 text-sm mt-2 font-serif italic">
            Soft outside, loud inside. Masuk untuk melanjutkan.
          </p>
        </div>
        ...
        <div className="p-6 bg-gray-100 border-t-2 border-gray-900 text-center">
          <p className="text-sm text-gray-600 font-medium">
            Belum menjadi bagian dari kami? <br className="md:hidden" />
            <Link 
              href="/register" 
